...
from .graph_utils import ensure_connected  # Use relative import for graph_utils
from .irrigation_utils import is_edge_valid  # Use relative import for irrigation_utils
